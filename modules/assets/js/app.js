...
$(document).ready(function () {
      ...
      if (res.stat === 'ok' && res.data) {
        ...
        Object.values(res.data).forEach(function (dept, key) {
          if (dept.counters) {
            ...
            $('#counter_carousel').append("\n              <div class=\"carousel-item ".concat(key === 0 ? 'active' : '', "\">\n                <div class=\"d-flex flex-column\" data-dept_id=\"").concat(dept.dept_id, "\">\n                  <div class=\"d-flex justify-content-between custom-rounded mg-b-10 pd-10 ht-100p\">\n                    <div class=\"d-flex flex-column justify-content-center\">\n                      <span class=\"dept-name mg-0 tx-semibold tx-white text-left text-wrap text-uppercase\">").concat(dept.dept_name, "</span>\n                    </div>\n\n                    <div class=\"d-flex flex-column justify-content-center\">\n                      <span class=\"tx-white now-serving mg-0 tx-semibold text-center text-uppercase\">Now Serving</span>\n                    </div>\n                  </div>\n                </div>\n              </div>\n            "));
  ...
  function announce(queue) {
    ...
    if (ANNOUNCED.includes(data.ann_id)) {
      ...
      CAROUSEL_PAGE = $(slide_dom).index() + 1; // Add blinking effect
  ...
  function carouselScroll(page) {
    ...
    document.querySelector('.carousel-item.active').scrollIntoView(); // Return to first slide
