...
<body>
  <div class="d-flex flex-column">
    <div class="custom-header container-fluid pd-y-10 justify-content-between d-flex">
      <div class="d-flex flex-column">
        <p class="mg-0">Counter #</p>
        <p class="mg-0">Department</p>
      </div>
      
      <div class="d-flex">
        <div class="d-flex flex-column justify-content-center ht-100p">
          <div class="profile-pic">
            <img alt="" src="http://lorempixel.com/output/cats-q-c-480-480-8.jpg" class="img-fluid">
          </div>
        </div>
        
        <div class="d-flex flex-column justify-content-center ht-100p">
          <p class="mg-0 mg-l-10">First Name</p>
        </div>
      </div>
    </div>
      ...
      <div class="d-flex ht-100p">
        <div class="summary-panel bg-teal">
          <div class="d-flex flex-column justify-content-between pd-10 ht-100p">
            ...
            <!-- SUMMARY -->
            <div class="custom-rounded d-flex flex-column pd-10 bg-white flex-grow-1 mg-b-10">
              ...
              <div class="d-flex flex-column justify-content-between">
                ...
                <p class="wd-75p mx-auto custom-rounded pd-10 bg-teal tx-white mg-0 text-center" id="time">00:00</p>
              </div>
            ...
            <!-- STATISTICS-->
            <div class="custom-rounded d-flex flex-column pd-10 bg-white" style="font-size: 2.5vmax">
              <p class="text-center text-uppercase tx-semibold tx-teal mg-0">Statistics</p>
        ...
        <div class="actions-panel bg-gray-400">
          <div class="d-flex flex-column pd-10 ht-100p">
            <button class="tx-semibold tx-uppercase custom-rounded btn btn-teal btn-block flex-grow-1 mg-b-5">Next</button>

            <div class="d-flex justify-content-between flex-grow-1 mg-y-5">
              <button class="tx-semibold tx-uppercase custom-rounded btn btn-warning wd-50p mg-r-5">Recall</button>
              <button class="tx-semibold tx-uppercase custom-rounded btn btn-success wd-50p mg-l-5">Done</button>
            </div>

            <div class="d-flex justify-content-between flex-grow-1 mg-t-5">
              <button class="tx-semibold tx-uppercase custom-rounded btn btn-secondary wd-50p mg-r-5">No Show</button>
              <button class="tx-semibold tx-uppercase custom-rounded btn btn-danger wd-50p mg-l-5">Cancel</button>
            </div>
